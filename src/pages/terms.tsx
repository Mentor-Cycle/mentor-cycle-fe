...
const Terms: NextPage = () => {
  return (
    <div className="container py-10">
      <h1 className="text-center font-bold text-3xl mt-8 mb-8 text-secondary-01">
        Termos de Uso da Mentor Cycle
      </h1>
      <p className="italic font-bold text-lg mb-8 text-secondary-01">
        1. Aceitação dos Termos de Uso
      </p>
      <p className="mb-4 text-secondary-01">
      ...
      <p className="mb-8 text-secondary-01">
      ...
      <h2 className="italic font-bold text-lg mb-8 text-secondary-01">
        4. Conduta do usuário
      </h2>

      <p className="text-secondary-01">
        {" "}
        Os usuários da plataforma Mentor Cycle concordam em não:
      </p>

      <ol className="list-disc list-inside flex flex-col gap-4 mb-4 text-secondary-01">
        <li className="mt-2 text-secondary-01 dark:text-neutral-01">
          Violar leis ou regulamentações aplicáveis;
        </li>
        <li className="text-secondary-01 dark:text-neutral-01">
