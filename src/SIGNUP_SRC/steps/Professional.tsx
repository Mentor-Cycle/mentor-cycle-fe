        ...
        <Controller
          ...
          render={({ field }) => (
            <textarea
              id={descriptionId}
              tabIndex={20}
              className="placeholder:text-gray-03 p-3 h-[9rem] rounded-lg text-neutral-02 outline-none focus:outline-1 focus:outline-gray-03 focus:outline-offset-2 bg-secondary-04 border border-gray-05"
